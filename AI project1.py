...
a = Tk()
a.title('AI NUTRITIONIST')

def BMR():

    protein = ['Soya CHunks(1 cup)','Cooked Chicken(3 Oz)','Cooked fish(4 Oz)','2 whole egg + 3 egg whites','Tofu(5 Oz)']
    fruit = ['watermelon(80 Oz)','Apple','Orange','Banana','Dried Fruits(Handfull)','Fruit Juice(125ml)']
    vegetable = ['Any vegetable(80g)']
    grains = ['Cooked Grain(150g)','Whole Grain Bread(1 slice)','Half Large Potato(75g)','boiled white rice(250g)','2 chappathi']
    ps = ['Soy nuts(i Oz)','Low fat milk(250ml)','(4 Tbsp)','Cottage cheese (125g)','Flavored yogurt(125g)']
